	...
	return (
		<ButtonGroup style={{
			...
			<Tooltip placement="top" title={"Inline Math"}>
				<Button onMouseDown={(e) => props.tagInsertion(e,'<Math inline="true"></Math> ', 20)}>
					iMath
				</Button>
			</Tooltip>

			<Tooltip placement="top" title={"Display math"}>
				<Button onMouseDown={(e) => props.tagInsertion(e,'<Math></Math> ', 6)}>
					dMath
				</Button>
			</Tooltip>
			...
			<Tooltip placement="top" title={"Numbered List"}>
				<Button onMouseDown={(e) => props.tagInsertion(e,'<ol>\n\t<li></li>\n</ol> ', 9)}>
					<Icon type="ordered-list"/>
				</Button>
			</Tooltip>

			<Tooltip placement="top" title={"Bulleted List"}>
				<Button onMouseDown={(e) => props.tagInsertion(e,'<ul>\n\t<li></li>\n</ul> ', 9)}>
			...
			<Tooltip placement="top" title={"Table"}>
				<Button
					onMouseDown={(e) => props.tagInsertion(e,'<table>\n\t<tr>\n\t<td></td></tr>\n</table> ', 19)}>
					<Icon type="table"/>
				</Button>
			</Tooltip>
		</ButtonGroup>
