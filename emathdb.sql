...
COPY public.presentation_rootlevel (id, html_title, date, author_id, contributor_id, author_index, index_item, symbol_index, new_command, tex_shortcut) FROM stdin;
