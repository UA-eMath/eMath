...
492	2020-06-14 14:10:33.098406-06	17	RootLevel object (17)	2	[{"changed": {"fields": ["tex_command"]}}]	13	1
493	2020-06-14 14:10:40.954429-06	2	RootLevel object (2)	2	[{"changed": {"fields": ["tex_command"]}}]	13	1
494	2020-06-14 14:10:47.636963-06	1	RootLevel object (1)	2	[{"changed": {"fields": ["tex_command"]}}]	13	1
\.
...
96	3	f	<Math inline="true">2^2</Math>	Theorem	\N	30	31	2	3	33	\N	\N
...
95	3	f	<Math inline="true">\\mathbb{R}^m\\times \\mathbb{R}^n = \\mathbb{R}^{m+n}</Math>	Proposition	\N	32	33	2	3	33	\N	\N
...
COPY public.presentation_rootlevel (id, html_title, date, author_id, contributor_id, author_index, index_item, symbol_index, tex_command) FROM stdin;
